<?php
  ...
  else
  {
    if(isset($_POST["btnCadastrar"]))
    {
      ...
      {
        include_once '../View/interfaces/cadastroRealizado.php';
      }
      else
      {
        include_once '../View/interfaces/cadastroNaoRealizado.php';
      }
    }
    else
    {
  ...
  if(isset($_POST["btnAtualizacaoCadastro"]) || isset($_POST["btnoperacaoNaoRealizada"]) || isset($_POST["btnInfInserir"]) || isset($_POST["btnInfExcluir"]))
  {
    include_once '../View/principal.php';
  }
  ...
  if(isset($_POST["btnAtualizar"]))
  {
    ...
    {
      include_once '../View/interfaces/atualizacaoRealizada.php';
    }
    else
    {
      include_once '../View/interfaces/operacaoNaoRealizada.php';
    }
  }
  ...
  if(isset($_POST["btnAddFormacao"]))
  {
    ...
    {
      include_once '../View/interfaces/informacaoInserida.php';
    }
    else
    {
      include_once '../View/interfaces/operacaoNaoRealizada.php';
  ...
  if(isset($_POST["btnExcluirFA"]))
  {
    ...
    {
      include_once '../View/interfaces/informacaoExcluida.php';
    }
    else
    {
      include_once '../View/interfaces/operacaoNaoRealizda.php';
    }
